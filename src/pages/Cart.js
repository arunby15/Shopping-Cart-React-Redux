...
const Cart = () => {
  ...
  return (
    <div>
      {cart.length > 0 ? (
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center mt-20">
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            <div className="flex flex-col p-5 gap-5 my-14  h-[100%] justify-between fixed">
              <div className="flex flex-col gap-5 ">
                <div className="font-semibold text-xl text-green-800 ">
                  Your Cart
                </div>
                <div className="font-extrabold text-5xl text-green-700  -mt-5">
                  SUMMARY
                </div>
                <p className="text-xl">
            ...
            <div className="flex flex-col mb-[90px] fixed mt-[720px]">
